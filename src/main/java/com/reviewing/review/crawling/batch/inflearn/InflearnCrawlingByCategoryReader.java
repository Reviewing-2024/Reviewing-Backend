...
@Slf4j
public class InflearnCrawlingByCategoryReader implements ItemStreamReader<CrawlingCourseDto> {
    ...
    public InflearnCrawlingByCategoryReader(PlatformRepository platformRepository,
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        ...
        driverForCourseData = new ChromeDriver(optionsForCourseData);
        ...
        driverForLastPage = new ChromeDriver(optionsForLastPage);

        WebDriverWait waitForLastPage = new WebDriverWait(driverForLastPage, Duration.ofSeconds(30));
        findLastPage(driverForLastPage, category.getSlug(), waitForLastPage);
    }
    ...
    private void inflearnCrawlingByOnePage(Integer page, WebDriverWait wait, Platform findPlatform) {
        log.info("페이지: {}",page);
        String url = "https://www.inflearn.com/courses/it-programming/" + category.getSlug()
